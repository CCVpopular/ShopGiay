...
namespace ShopGiay.Areas.Admin.Controllers
{
    ...
    public class PromotionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DiscountPercent")] Promotion promotion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DiscountPercent")] Promotion promotion)
        {
            if (id != promotion.Id)
            {
                return NotFound();
